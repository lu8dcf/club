  ...
  <?php include("../includes/head2.php") ?>
      <head>
        <link href="../css/socio.css" rel="stylesheet">
      ...
      <table>
        ...
        <tbody>
          ...
          <?php
              ...
              // si fue pulsada la opcion de BUSQUEDA se activara este filtro
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if (!empty($busca)) {
                        $query = "SELECT * FROM $tabla WHERE $campo1 LIKE '%$busca%' OR $campo2 LIKE '%$busca%' OR $campo3 LIKE '%$busca%'OR $campo4 LIKE '%$busca%'";
          ...
          <tr>
            ...
            <td class=boton>  
              <form id=vista-$tabla method="POST"  action="./vista_socio/perfil_socio.php" target="popup" onsubmit="vista()">
